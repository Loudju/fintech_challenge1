...
remaining_months = 9
print(f"Months left on loan is {remaining_months} months.")
# @TODO: Use the formula for Present Value to calculate a "fair value" of the loan.
# Use a minimum required return of 20% as the discount rate.
#   You'll want to use the **monthly** version of the present value formula.
#   HINT: Present Value = Future Value / (1 + Discount_Rate/12) ** remaining_months
present_value = future_value / (1 + .20 / 12) ** 9
print(f"Present value for the loan is ${present_value:.2f}")
...
if present_value >= price :
    print("This Loan is worth at least the cost to buy and is selling at a discount. Buy")
...
def calculate_present_value(future_value, remaining_months, annual_discount_rate):
    ...
    present_value_func = future_value / (1 + annual_discount_rate / 12) ** remaining_months

    return present_value_func




new_loan_pv = calculate_present_value(1000, 12, .20)
print(new_loan_pv)
